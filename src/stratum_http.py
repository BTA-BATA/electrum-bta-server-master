...
class SSBTAPServer(SocketServer.TCPServer):
...
class StratumHTTPSSLServer(SSBTAPServer, StratumJSONRPCDispatcher):
    ...
    def __init__(self, addr, certfile, keyfile,
        ...
        SSBTAPServer.__init__(self, addr, certfile, keyfile, requestHandler, bind_and_activate)
